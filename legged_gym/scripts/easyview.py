...
# create ant asset
asset_root = "../../resources/robots/solo/urdf/"
asset_file = "solo.urdf"
...
texture_files = os.listdir("../../resources/textures/")
loaded_texture_handle_list = []
for file in texture_files:
    if file.endswith(".jpg"):
        loaded_texture_handle_list.append(gym.create_texture_from_file(sim, os.path.join("../../resources/textures/", file)))
